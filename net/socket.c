...
static int __sys_setsockopt(int fd, int level, int optname, char __user *optval,
			    int optlen)
{
	int err, fput_needed;
	struct socket *sock;
...
static int __sys_getsockopt(int fd, int level, int optname, char __user *optval,
			    int __user *optlen)
{
	int err, fput_needed;
	struct socket *sock;
				 ...
				 struct iovec **iov)
{
	...
	return import_iovec(save_addr ? READ : WRITE, msg.msg_iov,
...
static int compat_dev_ifconf(struct net *net,
